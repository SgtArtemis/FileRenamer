...
public class RenamerForGUI {
	...
	public static void main(String [] args) throws IOException {
		...
		renamer.runRenamer("G:\\Serier\\", "Sherlock", 1);
	}
	...
	public void runRenamer(String directoryString, String series, int showNumber) throws IOException {
		 ...
		 */
		// TODO  - Make the file ending support folders as well
		...
		if(filenames != null) {
			...
			for(int i = 0; i < filenames.length; i++){
				...
				episodeName = episodeNames.get(i);
	...
	public void deleteFile(String series, String directory) {

		File file = new File(directory + "\\" + series + ".txt");
		System.out.println(directory + "\\" + series + ".txt");

		try{


			if(file.delete()){
				JOptionPane.showMessageDialog(null, "To name the episodes we created a temporary text file.\nThis text file has now been successfully deleted.");
			}

			else{
				JOptionPane.showMessageDialog(null, "Delete operation failed. This doesn't really matter though.");
			}
